            ...
            <div>
                <div>
                    <div id="barContainer">
                        ...
                        <DashboardBarGraph v-bind:dataCollection="barGraphData" v-bind:isLoading="barLoading" v-bind:loadingCount="countryCount" ></DashboardBarGraph>
                    </div>
                    <div id="threatContainer">
                        <DashboardThreatCard v-bind:count="threatCardData.singapore.array" v-bind:isLoading="barLoading"></DashboardThreatCard>
                    </div>
                    <div id="bubbleContainer">
                        <p class="graphTitle">Proportion of Endangered Species in the World</p>
                        <DashboardBubbleGraph v-bind:dataCollection="bubbleGraphData" v-bind:loadingCount="countryCount"></DashboardBubbleGraph>
                    </div>
                </div>
            </div>
        </div>
...
import DashboardThreatCard from '../components/DashboardThreatCard.vue';
import DashboardBarGraph from "../components/DashboardBarGraph.vue";
import DashboardBubbleGraph from "../components/DashboardBubbleGraph.vue";
