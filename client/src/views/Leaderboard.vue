<template>
    <div>
        ...
        <div v-show="Object.keys(userContribution).length!=0">
            <BasePageHeader v-bind:header="'Leaderboard'" v-bind:icon="'trophy'" v-bind:description="description" v-bind:subDescription="subDescription"/>
            <div class="row">
        ...
        <div id="noContributions" v-show="Object.keys(userContribution).length==0">
            <BasePageHeader v-bind:header="'Leaderboard'" v-bind:icon="'trophy'"/>
