<template>
    <div>
        <NavigationBar/>
        <div>
            <BasePageHeader v-bind:header="'Feed An Animal Today!'" v-bind:icon="'home'" v-bind:description="description" v-bind:subDescription="subDescription"/>
            <div id="container">
...
import FeedMeButton from '../components/FeedMeButton.vue';
