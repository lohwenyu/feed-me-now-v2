    ...
    <div id="mainContainer">
        ...
        <div id="animalContainer">
            ...
            <div class="counterContainer">
                <ContributionsCounter v-bind:mealQuantity="array[0]" v-bind:feastQuantity="array[1]" v-bind:page="'leaderboard'"/>
            ...
            <LeaderboardContributors v-bind:rankedContributors="rankedContributors" v-bind:animalId="animalId"/>
        </div>
    </div>
</template>
...
import ContributionsCounter from "./ContributionsCounter.vue";
